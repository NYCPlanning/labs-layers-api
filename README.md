...
Note: If you are updating, changing or adding the query for a layer group, you must also change the corresponding query in the front end (for example: ZoLa or Population Factfinder).
